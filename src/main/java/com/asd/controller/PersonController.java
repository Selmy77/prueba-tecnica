...
import com.asd.repository.PersonRepository;
...
public class PersonController {
	...
	@RequestMapping(value = "/{id}/actives", method = RequestMethod.GET)
	public ResponseEntity<Collection<Active>> getPersonParties(@PathVariable long id) {
		Person person = personRepo.findOne(id);

		if (person != null) {
			return new ResponseEntity<>(person.getActives(), HttpStatus.OK);
		} else {
			return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);
		}
	}
